<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="newsadd.aspx.cs" Inherits="Admin_newsadd" %>
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Add/Edit News & Events</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            ...
                            <asp:TextBox ID="txtcategory" runat="server" ValidationGroup="save" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
