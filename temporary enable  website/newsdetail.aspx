    ...
    <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <div class="news-simple-card">
                ...
                <img  src="../../images/news/large/<%# Eval("newsimage1")%>" alt="" style="width:80%"/>
                <div class="list">
                    <ul>
                        <li><i class="flaticon-clock"></i><%#Eval("newsdate", "{0:dd/M/yyyy}")%></li>
                    </ul>
                </div>
                 <h3><%# Eval("newstitle")%></h3>
                <%# Eval("newslongdescription")%>
            </div>
            ...
            <div class="blog-img-and-content">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="../../images/news/large/<%# Eval("newsimage1")%>" target="_blank"><img src="../../images/news/title/<%# Eval("newsimage1")%>" alt="Image"/></a>
                    </div>
                    <%} %>
                    <% if (image2 != "") { %>
                    <div class="col-lg-4 col-md-6">
                        <a href="../../images/news/large/<%# Eval("newsimage2")%>" target="_blank"><img src="../../images/news/large/<%# Eval("newsimage2")%>" alt="Image"/></a>
                    </div>
                    <%} %>
                    <% if (image3 != "") { %>
                    <div class="col-lg-4 col-md-6">
                        <a href="../../images/news/large/<%# Eval("newsimage3")%>" target="_blank"><img src="../../images/news/large/<%# Eval("newsimage3")%>" alt="Image"/></a>
                    </div>
                    <%} %>
                    <% if (image4 != "") { %>
                    <div class="col-lg-4 col-md-6">
                        <a href="../../images/news/large/<%# Eval("newsimage4")%>" target="_blank"><img src="../../images/news/large/<%# Eval("newsimage4")%>" alt="Image"/></a>
                    </div>
                    <%} %>
                    <% if (image5 != "") { %>
                    <div class="col-lg-4 col-md-6">
                        <a href="../../images/news/large/<%# Eval("newsimage5")%>" target="_blank"><img src="../../images/news/large/<%# Eval("newsimage5")%>" alt="Image"/></a>
                    </div>
                    <%} %>
                    <% if (image6 != "") { %>
                    <div class="col-lg-4 col-md-6">
                        <a href="../../images/news/large/<%# Eval("newsimage6")%>" target="_blank"><img src="../../images/news/large/<%# Eval("newsimage6")%>" alt="Image"/></a>
                    </div>
                    <%} %>
                </div>
            </div>
...
<script src="../../assets/js/custom.js"></script>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-39WQPEZEFW"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'G-39WQPEZEFW');
</script>
</body>
</html>
